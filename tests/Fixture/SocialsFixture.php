...
class SocialsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'social_type_key' => ['type' => 'index', 'columns' => ['social_type_id'], 'length' => []],
            'user_key' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'socials_ibfk_1' => ['type' => 'foreign', 'columns' => ['social_type_id'], 'references' => ['social_types', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'socials_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
